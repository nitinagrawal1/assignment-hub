...
const [pricingData, setPricingData] = useState<any>(null);
    ...
    <div className="flex flex-col gap-11">
        <div className="flex flex-col gap-5 ">
            <h2 className="max-w-3xl">Affordable plans for every student</h2>
            <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                Get your assignments, reports, and dissertations done by experts without breaking your budget. 
                Choose a plan that fits your academic needs — quality, originality, and timely delivery guaranteed.
            </p>
        </div>
    </div>
</div>
                                ...
                                {pricingData?.data?.map((value:any, index:any) => {
                                    return (
                                        <div key={index} className="bg-white dark:bg-lightgray/10 p-3 sm:p-5 xl:p-12 flex flex-col gap-10">
                                            ...
                                            <div>
                                                <Link     href="https://wa.me/919079008119" 
    target="_blank" className="group relative flex justify-center items-center w-full bg-primary hover:bg-secondary rounded-full transition-all duration-300 ease-in-out">
                                                    <span className="py-4 px-2 text-lg font-bold text-secondary group-hover:text-white transition-all duration-300 ease-in-out">Contact now</span>
