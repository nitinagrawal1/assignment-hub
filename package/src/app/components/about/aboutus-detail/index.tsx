    ...
    Assignment Solutions
                    ...
                    <div className='flex flex-col gap-12'>
                        <p className="text-secondary dark:text-white">
                            At Assignment Solutions, we specialize in delivering top-quality, plagiarism-free academic content for students across the globe. 
                        ...
                        <p className='text-secondary dark:text-white'>
                            We know how challenging it can be to manage tight deadlines and multiple subjects. That’s why Assignment Solutions provides personalized writing support for every academic need. 
